...
function applyTheme(isLight) {
    if (isLight) {
        ...
        hideCanvas(false);
        console.log('animate() function disabled!');
    } else {
        $('p, h1, h3, .nav-link').css('color', 'white');
        $('.projects').removeClass('theme-white-projects').addClass('theme-dark-projects');
        $('.edu').removeClass('theme-white-edu').addClass('edu-dark-theme');
        ...
        hideCanvas(true);
        console.log('animate() function revoked!');
    }
}
...
>>>>>>> fdc4d60 (Update portfolio with new features and fixes for v1.1)
